                ...
                <!-- //gallery container -->
                        ...
                        <fieldset>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XX71</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XX71" name="17XX71" placeholder="17XX71" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XX72</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XX72" name="17XX72" placeholder="17XX72" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XX73</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XX73" name="17XX73" placeholder="17XX73" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XX74x</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XX74x" name="17XX74x" placeholder="17XX74x" required>
                              </div>
                            </div>
                      </fieldset>
                    </div>
                    ...
                    <div class="col-5">
                      <fieldset>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XX75x</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XX75x" name="17XX75x" placeholder="17XX75x" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XXL76</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XXL76" name="17XXL76" placeholder="17XXL76" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XXL77</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XXL77" name="17XXL77" placeholder="17XXL77" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XXP78</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XXP78" name="17XXP78" placeholder="17XXP78" required>
                              </div>
                            </div>
                        </fieldset>
                        <br>
