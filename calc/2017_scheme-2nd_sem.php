...
<body>
                ...
                <!-- //gallery container -->
                        ...
                        <fieldset>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17MAT21</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17MAT21" name="17MAT21" placeholder="17MAT21" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XXX22</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XXX22" name="17XXX22" placeholder="17XXX22" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XXX23</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XXX23" name="17XXX23" placeholder="17XXX23" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XXX24</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XXX24" name="17XXX24" placeholder="17XXX24" required>
                              </div>
                            </div>
                      </fieldset>
                    </div>
                    ...
                    <div class="col-5">
                      <fieldset>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XXX25</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XXX25" name="17XXX25" placeholder="17XXX25" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XXL26</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XXL26" name="17XXL26" placeholder="17XXL26" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XXL27</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XXL27" name="17XXL27" placeholder="17XXL27" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XXX28</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XXX28" name="17XXX28" placeholder="17XXX28" required>
                              </div>
                            </div>
                        </fieldset>
                        <br>
  ...
  <script type="text/javascript">
    document.getElementById('2ndsem').onsubmit = function() {
        ...
        const sub = ["17MAT21", "17XXX22", "17XXX23", "17XXX24", "17XXX25", "17XXL26", "17XXL27", "17XXX28"];
