                ...
                <!-- //gallery container -->
                        ...
                        <fieldset>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17MAT41</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17MAT41" name="17MAT41" placeholder="17MAT41" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XX42</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XX42" name="17XX42" placeholder="17XX42" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XX43</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XX43" name="17XX43" placeholder="17XX43" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XX44</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XX44" name="17XX44" placeholder="17XX44" required>
                              </div>
                            </div>
                      </fieldset>
                    </div>
                    ...
                    <div class="col-5">
                      <fieldset>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XX45</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XX45" name="17XX45" placeholder="17XX45" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XX46</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XX46" name="17XX46" placeholder="17XX46" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XXL47</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XXL47" name="17XXL47" placeholder="17XXL47" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XXL48</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XXL48" name="17XXL48" placeholder="17XXL48" required>
                              </div>
                            </div>
                        </fieldset>
                        <br>
                      ...
                      <div class="row justify-content-md-center">
                        <div class="col-5">
                          <div class="form-row">
                            <div class="form-group col-md-6 mb-4">
                                <label class="col-form-label">17KL/CPH49</label>
                            </div>
                            <div class="col-md-6 mb-4">
                              <input type="text" class="form-control" id="17KL/CPH49" name="17KL/CPH49" placeholder="17KL/CPH49" required>
                            </div>
                          </div>
                        </div>
                      </div>
  ...
  <script type="text/javascript">
    document.getElementById('4thsem').onsubmit = function() {
        ...
        const credits = [[4,4,4,4,4,3,2,2,1],//ae
                         ...
                         [4,3,4,4,4,4,2,2,1],//ec
                         [4,3,4,4,4,4,2,2,1]];
        const sub = ["17MAT41", "17XX42", "17XX43", "17XX44", "17XX45", "17XX46", "17XXL47", "17XXL48", "17KL/CPH49"];
