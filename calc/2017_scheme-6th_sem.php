...
<body>
                ...
                <!-- //gallery container -->
                        ...
                        <fieldset>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XX61</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XX61" name="17XX61" placeholder="17XX61" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XX62</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XX62" name="17XX62" placeholder="17XX62" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XX63</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XX63" name="17XX63" placeholder="17XX63" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XX64</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XX64" name="17XX64" placeholder="17XX64" required>
                              </div>
                            </div>
                      </fieldset>
                    </div>
                    ...
                    <div class="col-5">
                      <fieldset>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XX65x</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XX65x" name="17XX65x" placeholder="17XX65x" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XX66x</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XX66x" name="17XX66x" placeholder="17XX66x" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XXL67</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XXL67" name="17XXL67" placeholder="17XXL67" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XXL68</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XXL68" name="17XXL68" placeholder="17XXL68" required>
                              </div>
                            </div>
                        </fieldset>
                        <br>
  ...
  <script type="text/javascript">
    document.getElementById('6thsem').onsubmit = function() {
        ...
        const sub = ["17XX61", "17XX62", "17XX63", "17XX64", "17XX65x", "17XX66x", "17XXL67", "17XXL68"];
