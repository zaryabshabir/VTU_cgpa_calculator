...
<body>
                ...
                <!-- //gallery container -->
                        ...
                        <fieldset>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">18XX81</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="18XX81" name="18XX81" placeholder="18XX81" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">18XX82x</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="18XX82x" name="18XX82x" placeholder="18XX82x" required>
                              </div>
                            </div>
                      </fieldset>
                    </div>
                    ...
                    <div class="col-5">
                      <fieldset>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">18XXP83</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="18XXP83" name="18XXP83" placeholder="18XXP83" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">18XXS84</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="18XXS84" name="18XXS84" placeholder="18XXS84" required>
                              </div>
                            </div>
                        </fieldset>
                        <br>
                      ...
                      <div class="row justify-content-md-center">
                        <div class="col-5">
                          <div class="form-row">
                            <div class="form-group col-md-6 mb-4">
                                <label class="col-form-label">18XXI85</label>
                            </div>
                            <div class="col-md-6 mb-4">
                              <input type="text" class="form-control" id="18XXI85" name="18XXI85" placeholder="18XXI85" required>
                            </div>
                          </div>
                        </div>
                      </div>
  ...
  <script type="text/javascript">
    document.getElementById('8thsem').onsubmit = function() {
        ...
        var sum=0;
        var sqpa;
        const credits = [3,3,8,1,3]
        const sub = ["18XX81", "18XX82x", "18XXP83", "18XXS84", "18XXI85"];
