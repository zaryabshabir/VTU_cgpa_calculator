                ...
                <!-- //gallery container -->
                        ...
                        <fieldset>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17MAT31</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17MAT31" name="17MAT31" placeholder="17MAT31" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XX32</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XX32" name="17XX32" placeholder="17XX32" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XX33</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XX33" name="17XX33" placeholder="17XX33" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XX34</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XX34" name="17XX34" placeholder="17XX34" required>
                              </div>
                            </div>
                      </fieldset>
                    </div>
                    ...
                    <div class="col-5">
                      <fieldset>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XX35</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XX35" name="17XX35" placeholder="17XX35" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XX36</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XX36" name="17XX36" placeholder="17XX36" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XXL37</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XXL37" name="17XXL37" placeholder="17XXL37" required>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6 mb-4">
                                  <label class="col-form-label">17XXL38</label>
                              </div>
                              <div class="col-md-6 mb-4">
                                <input type="text" class="form-control" id="17XXL38" name="17XXL38" placeholder="17XXL38" required>
                              </div>
                            </div>
                        </fieldset>
                        <br>
                      ...
                      <div class="row justify-content-md-center">
                        <div class="col-5">
                          <div class="form-row">
                            <div class="form-group col-md-6 mb-4">
                                <label class="col-form-label">17KL/CPH39</label>
                            </div>
                            <div class="col-md-6 mb-4">
                              <input type="text" class="form-control" id="17KL/CPH39" name="17KL/CPH39" placeholder="17KL/CPH39" required>
                            </div>
                          </div>
                        </div>
                      </div>
  ...
  <script type="text/javascript">
    document.getElementById('3rdsem').onsubmit = function() {
        ...
        const credits = [[4,4,4,4,4,3,2,2,1],//ae *
                         ...
                         [4,3,4,4,4,4,2,2,1],//ec pending
                         [4,3,4,4,4,4,2,2,1]];//ec pending
        const sub = ["17MAT31", "17XX32", "17XX33", "17XX34", "17XX35", "17XX36", "17XXL37", "17XXL38", "17KL/CPH39"];
